          ...
          <div className="lg:flex lg:items-center lg:justify-between lg:gap-4">
            ...
            <form className="mt-4 w-full gap-4 sm:flex sm:items-center sm:justify-end lg:mt-0">
              ...
              <Button type="button" data-modal-target="question-modal" data-modal-toggle="question-modal"
                      className="mt-4 w-full shrink-0 rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0 sm:w-auto">Ask
                a question
              </Button>
            </form>
          </div>
