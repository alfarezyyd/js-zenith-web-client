              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                    ...
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-front-image.png"
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-iphone-14.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    Apple iPhone 14
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Phone</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-ipad-air.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    Apple iPad Air
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Tablet</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-s.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    Xbox Series S
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Console</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/playstation-5.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    PlayStation 5
                  </th>
                  <td className="px-4 py-2">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-x.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    Xbox Series X
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Gaming/Console</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-watch-se.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    Apple Watch SE
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Watch</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                      <div className="inline-block w-4 h-4 mr-2 bg-yellow-300 rounded-full"></div>
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/nikon-d850.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
                    NIKON D850
                  </th>
                  <td className="px-4 py-2">
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Photo/Video</span>
                  </td>
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="flex items-center">
                ...
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <th scope="row"
                      className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/benq-ex2710q.png"
                           alt="iMac Front Image" className="w-auto h-8 mr-3"/>
