        ...
        <div
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <Button type="button" as={Link} href={`${process.env.NEXT_PUBLIC_BACKEND_URL}/auth/google`}
                      className="w-full text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 mx-auto flex justify-center dark:focus:ring-[#4285F4]/55">
