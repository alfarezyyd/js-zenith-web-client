                ...
                <tbody>
                {
                    ...
                    return (
                      <tr key={index}
                        ...
                        <th scope="row"
                          ...
                          <Image src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/stores/${value.resources[0].image_path}`}
                  ...
                  <span
                    className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{value.category[0].name}</span>
                        ...
                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{value.weight}
                        </td>
                      </tr>
