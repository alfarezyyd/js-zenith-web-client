...
export default function Page({params}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/stores/${params.slug[0]}`, {
        method: 'POST',
        cache: 'no-store',
        headers: {
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div className="w-full">
              <div className="relative">
                ...
                />
                <label htmlFor="sku"
                       className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4">SKU
          ...
          <label htmlFor="image"
                 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white my-8">Gambar</label>
          <div className="sm:col-span-2">
            <div className="flex items-center justify-center w-full">
              <label htmlFor="image"
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">Klik untuk mengunggah</span> atau
                    tarik dan letakkan</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG atau GIF (MAX. 800x400px)</p>
                </div>
                <input
                  id="image"
                  type="file"
          ...
          <button type="submit"
                  className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">Tambah
            Produk
          </button>
        </form>
      </div>
